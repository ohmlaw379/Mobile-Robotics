...
case 0:
    ZeroJunction();
    Serial.println("Going to Junction 0");
  ...
  case 2:
    Serial.println("Going to Junction  2");
    TwoJunction();
    break;
    
  case 3:
    Serial.println("Going to Junction  3");
    ThreeJunction();
    break;
    
  case 4:
    Serial.println("Going to Junction  4");
    FourJunction();
    break;
    
  case 5:
    Serial.println("Going to Junction  5");
    FiveJunction();
    break;
