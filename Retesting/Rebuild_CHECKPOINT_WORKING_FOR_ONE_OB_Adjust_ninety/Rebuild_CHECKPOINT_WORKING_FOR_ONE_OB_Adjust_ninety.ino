...
char password[] = "duettino33isocarbostyril";
//char password[] = "profounds95nephritides";
...
int turn[5][4] = {
  { 255, 175, 255, 186 },  //forward //  {255, 152, 255, 164}, //forward
...
//obstacle if statement 
  if (distance_sensor_reading > 2200){ //detects obstacle
...
void turn90_function(int direction_of_turn){
  ...
  if (direction_of_turn == -1) {
    ...
    AnalogValue[3]=analogRead(AnalogPin[2]);
    delay(5);
