...
int checker = 0; // used to check junctions after obstacles 
int junction = 0; 
...
//obstacle if statement 
  if (distance_sensor_reading > 2000){ //detects obstacle
    for (int s = 0; s < 3; s++){ //checks 3 times
      distance_sensor_reading=analogRead(distance_sensor);
      if (distance_sensor_reading > 2150){
        obstacle_count++;
        delay(5);
      }
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      drive(turn[sensors_between_line][0], turn[sensors_between_line][1], turn[sensors_between_line][2], turn[sensors_between_line][3], 0, turn[0][1], 0, turn[0][3]);
