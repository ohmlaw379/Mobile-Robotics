...
String preparePostBody(int position);
bool sendPostRequest(String postBody);
String readResponse();
...
bool sendPostRequest(String postBody) {
    if (client.connected()) {
        ...
        Serial.println("Failed to send POST request: Client not connected.");
        return false;
    }
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...

// Handle the response by checking the status and updating the position
bool handleResponse(String response) {
    ...
    if (!body.equals("undefined")) {
        ...
        if (destination == -1) {
            handleFinalStop();
            return false; // Exit the loop permanently
        } else {
...
int getStatusCode(String response) {
    int statusCode = 0;
    int statusStart = response.indexOf("HTTP/1.1") + 9; // Find the start of the status code
    if (statusStart > 0) {
        int statusEnd = response.indexOf(" ", statusStart);
        if (statusEnd > statusStart) {
            statusCode = response.substring(statusStart, statusEnd).toInt();
        }
    }
    return statusCode;
}
...

// Handle the final stop
void handleFinalStop() {
    Serial.println("Final stop reached. Stopping the robot.");
    while (true) {
        delay(1000); // Permanently halt the program
    }
}

